...
class XAIFormatter:
    ...
    def format(
        ...
        return {
            ...
            'actuarial_metrics': {
                ...
                'historical_sample_size': actuarial_scores.get('historical_sample_size', 0),
    ...
    def _build_agent_breakdown(self, coordinator_output: Dict) -> Dict:
        ...
        for agent_name, agent_data in agent_signals.items():
            ...
            breakdown[agent_name] = {
                ...
                'data_quality': round(agent_data.get('data_quality', 1.0), 2),
                'evidence_count': int(agent_data.get('evidence_count', 0)),
    ...
    def _extract_key_features(self, agent_name: str, features: Dict) -> List[str]:
        ...
        if agent_name == 'TechnicalV2':
            ...
            if 'macd_diff' in features and features['macd_diff'] != 0:
    ...
    def _build_coordinator_analysis(self, coordinator_output: Dict) -> Dict:
        ...
        return {
            ...
            'weight_metadata': coordinator_output.get('weight_metadata', {}),
        }
