...
from .views_market_intelligence import market_analyze, market_candles
...
urlpatterns = [
    path('v2/market/candles/', market_candles, name='v2-market-candles'),
    path('v2/market/analyze/', market_analyze, name='v2-market-analyze'),
    path('v2/news/recent/', recent_news_feed, name='v2-news-recent'),
    path('v2/register/voice-transcribe/', register_voice_transcribe, name='v2-register-voice-transcribe'),
