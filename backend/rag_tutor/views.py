...
Endpoints:
    ...
    POST   /api/tutor/rag/query/               — ask a question (RAG)
"""
...
from .services.ollama_service import generate_answer, get_embedding
...
class RagQueryView(APIView):
    ...
    def post(self, request):
        ...
        hits = retrieve_top_chunks(query_emb, user_email, top_k=5, min_score=0.20)
