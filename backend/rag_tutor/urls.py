...
from .views import DocumentDeleteView, DocumentListView, DocumentUploadView, RagQueryView, RagStreamView
...
urlpatterns = [
    ...
    path("rag/stream/",              RagStreamView.as_view(),      name="tutor-stream"),
]
