...
/**
 * /api/chat — conversational assistant endpoint.
 *
 * Pipeline: User text (no /agent prefix) → here → streamed response.
 *
 * Constraints:
 *  - No tool execution
...
- Multi-agent forex platform for smarter trading decisions.
- 3 AI agents: Technical (market indicators), Macro (economic context), Sentiment (market news).
- 4 currency pairs: EUR/USD, USD/JPY, GBP/USD, USD/CHF.
- Backtesting uses backend market data and returns current calculated metrics.
- Pages: Dashboard, Trading, Signal Lab, News, Reports, Strategy Tutor, Backtesting, Monitoring, Billing.
