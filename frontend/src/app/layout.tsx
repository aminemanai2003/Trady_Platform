      ...
      >
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var s=localStorage.getItem("trady-theme")||"dark";var t=location.pathname==="/"?"dark":s;document.documentElement.classList.toggle("dark",t==="dark");document.documentElement.dataset.theme=t;}catch(e){}`,
          }}
        />
