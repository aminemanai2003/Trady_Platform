    ...
    return (
        ...
        >
            <div className="flex items-center gap-2">
                ...
                <div>
                    <span className="text-sm font-bold text-white">Probabilistic risk estimate</span>
                    <p className="text-[10px] text-slate-500">
                        {historical_sample_size > 0
                            ? `${historical_sample_size} settled trades, blended with conservative priors`
                            : "Cold start: conservative priors, no settled pair history yet"}
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                />
                <KpiTile
                    label="Estimated win likelihood"
                    tooltip={`Model estimate derived from signal confidence and ${probability_basis.replaceAll("_", " ")}. It is not a measured certainty.`}
            ...
            <div className="space-y-3 pt-1">
                <MetricBar
                    ...
                    tooltip="Estimated likelihood from the current evidence and available outcome history."
                ...
                <MetricBar
                    ...
                    tooltip="Estimated complementary loss likelihood, not a guaranteed frequency."
