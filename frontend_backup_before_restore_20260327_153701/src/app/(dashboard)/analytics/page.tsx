...
const TABS = [
    ...
    { id: "macro",       label: "Indicateurs Macro (DSO1.1)", icon: Brain },
            ...
            <div className="relative z-10 flex-1 overflow-auto p-6 space-y-6">
                ...
                <FadeInUp>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {[
                            { label: "P&L Cumulé (90j)", value: perf.pnl, prefix: "$", color: perf.pnl >= 0 ? "text-emerald-400": "text-rose-400" },
                    ...
                    <StaggerContainer className="space-y-4">
                        <StaggerItem>
                            <div className="rounded-xl border border-white/5 bg-white/[0.03] p-5">
                                <div className="mb-4">
                                    <h3 className="text-sm font-bold text-white">Courbe Equity — 90 jours (DSO2.2)</h3>
                                    <p className="text-[11px] text-slate-500">Walk-forward validation sur données historiques 5 ans</p>
                                </div>
                        ...
                        <StaggerItem>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="rounded-xl border border-white/5 bg-white/[0.03] p-5">
                                    <h3 className="text-sm font-bold text-white mb-4">P&L Journalier</h3>
                ...
                {tab === "macro" && (
                    <StaggerContainer className="space-y-3">
                        <StaggerItem>
                            <div className="rounded-xl border border-white/5 bg-white/[0.03] p-5">
                                <h3 className="text-sm font-bold text-white mb-1">Indicateurs Macroéconomiques (DSO1.1)</h3>
                                <p className="text-[11px] text-slate-500 mb-4">Source: FRED API · Banques centrales · Dernières valeurs</p>
                                    ...
                                    {macro.map((m, i) => (
                                        <motion.div key={i} initial={{opacity:0,x:-10}} animate={{opacity:1,x:0}} transition={{delay:i*0.05}}
                                            ...
                                            <div>
                                                ...
                                                <div className="text-[10px] text-slate-500">Précédent: {m.prev} · Zone: {m.zone}</div>
                                            </div>
                ...
                {tab === "sentiment" && (
                    <StaggerContainer>
                        <StaggerItem>
                            <div className="rounded-xl border border-white/5 bg-white/[0.03] p-5">
                                <h3 className="text-sm font-bold text-white mb-1">Score Sentiment NLP par Paire (DSO1.3)</h3>
                                <p className="text-[11px] text-slate-500 mb-4">FinBERT · News Reuters · Score −1 (bearish) → +1 (bullish)</p>
